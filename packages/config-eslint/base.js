...
module.exports = [
  ...
  eslintConfigPrettier,
  {
    ...
    // opt into here. We also add one targeted react rule: jsx-child-element-spacing
    // catches missing spaces between an inline element (e.g. <strong>) and
    // adjacent text at line wraps — a bug that shipped to the account page.
    rules: {
