...
const mediaQuery = "(max-width: 1679px) and (min-height: 700px)";
export function Ads160x600Desktop({ title }: { title: string }): JSX.Element {
  ...
  return (
    <AdsContainer title={title} className="right-0 bottom-0">
      <div ref={adRef} className={cn("w-[160px] h-[600px] bg-background/50")} />
    </AdsContainer>
  );
}
