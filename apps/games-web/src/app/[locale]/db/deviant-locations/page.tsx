...
export default async function DeviantLocations(): Promise<JSX.Element> {
    ...
    <>
      <JSONLDScript
        json={{
          ...
          mainEntityOfPage: "https://oncehuman.th.gl/db/deviant-locations",
        }}
      />
      <JSONLDScript
        json={{
          ...
          itemListElement: [
            ...
            },
            {
              ...
              item: "https://oncehuman.th.gl/db/deviant-locations",
            },
          ],
        }}
      />
