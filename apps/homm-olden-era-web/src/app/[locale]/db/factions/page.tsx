  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-6">
        <EntityGrid entries={factions} section="factions" dict={dict} locale={locale} nameLabelPrefix="faction_" />

        <h2 className="text-lg font-semibold mt-8 mb-4">
          {resolveDict(dict, "specializations")}
        </h2>
        <EntityGrid entries={specializations} section="factions" dict={dict} locale={locale} groupLabelPrefix="faction_" />

        <h2 className="text-lg font-semibold mt-8 mb-4">
          {resolveDict(dict, "faction_laws")}
        </h2>
        <EntityGrid entries={factionLaws} section="factions" dict={dict} locale={locale} groupLabelPrefix="faction_" />
      </div>
    </>
  );
}
