...
export const metadata: Metadata = {
  ...
  description: `Explore ${APP_CONFIG.title} interactive maps for Living Lands, and Dawnshire Map, featuring ${APP_CONFIG.keywords!.slice(0, 5).join(", ")}, and more locations. Stay updated with the latest map updates and guides!`,
  openGraph: {
    url: `/`,
  },
};
export default async function Home() {
  ...
  const cards = mapNames.map((map) => {
    const mapName = translate(dict, map);
    return {
      title: `${mapName} Map`,
        ...
        header={
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Explore the Living Lands, Dawnshire Map, and the Dungeons and more
              in Avowed with {APP_CONFIG.keywords!.join(", ")}, plus more
              locations brought you by{" "}
