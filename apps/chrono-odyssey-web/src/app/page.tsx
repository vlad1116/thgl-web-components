...
export const metadata: Metadata = {
  ...
  description: `Explore ${APP_CONFIG.title} interactive maps for Setera, featuring ${APP_CONFIG.keywords!.slice(0, 5).join(", ")}, and more locations. Stay updated with the latest map updates!`,
  openGraph: {
    url: `/`,
  },
};
